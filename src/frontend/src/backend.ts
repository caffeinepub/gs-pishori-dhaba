...
export class Backend implements backendInterface {
    ...
    async getAllTableReservations(): Promise<Array<TableReservation>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllTableReservations();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async reserveTable(arg0: string, arg1: string, arg2: string, arg3: string, arg4: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.reserveTable(arg0, arg1, arg2, arg3, arg4);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
